     ...
     * If the user is adding initial Liquidity, user decides the 
     * ether and CD tokens he wants to add to the exchange. if he 
     * is adding the liquidity after the initial liquidity has 
     * already been added, then we calaculate the Crypto Dev tokens
     *  he can add, given the Eth he wants to add by keeping the ratios 
     * constant.
     */
export const addLiquidity = async (
    ...
    try {
        ...
        await tx.wait();
        // After the contract has the approval, add the  ether and cd tokens to the liquidity
